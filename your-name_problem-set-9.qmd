...
# To make the list of steps cross-referenceable, I'm hijacking the "remark" 
# environment (see https://quarto.org/docs/authoring/cross-references.html#theorems-and-proofs)
# This changes the "Remark" text to "Process"
language:
  environment-remark-title: "Process"
  crossref-rem-prefix: "Process"
---
...
At the [guide to example data](https://evalsp26.classes.andrewheiss.com/example/synthetic-data.html#specific-examples) at the course website, I provide this overview (see @rem-process) of the general steps involved in generating synthetic data:
...
In this section, I provide you with the content for steps 1–3 in @rem-process. In your final project, you'll have to do those steps yourself.

## DAG

> @rem-process, step 1: Draw a DAG that maps out how all the columns you care about are related
...
## Node measurement and relationships

> @rem-process, step 2: Specify how those nodes are measured
...
> @rem-process, step 3: Specify the relationships between the nodes based on the DAG equations
...
> @rem-process, step 5: Verify all relationships with plots and models
...
> @rem-process, step 7: Save the data
